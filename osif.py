...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'RSecxXx.iĐ' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'RSecxXx.iĐ' + W +'/' + R +'Bot ' + W + '>> ')
